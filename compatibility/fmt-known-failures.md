...
**Current baseline: `fmt-known-failures.json`, 797 entries** — 22 from before the
wave-2 corpus enrolment and 775 in the current expanded-corpus population.
...
Partition of `fmt-known-failures.json` by cluster: `3 + 8 + 6 + 1 + 1 + 1 + 2 + 388 + 239 + 85 + 45 + 14 + 1 + 2 + 1`

## Wave-2 enrolment (#3130) — Clusters 20-27

The corpus went from 37 to 104 corpus sources, and the formatter-parity set
with it. The current run has **33,446 included components, 32,623 matched, 797
...
that expanded-population residue to 775. At enrolment time 51 repositories
...
of 775 entries classifies as shown below. Read that as the property of this table it has always
...
**627 of 775 (81%) are cluster 20 or 21 — one question, where a line breaks** —
